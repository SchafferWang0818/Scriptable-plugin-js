...
try {
  ...
  var checkintitle = res[para].title || "FreeMyCloud"; //填写签到标题
  var checkinloginurl = res[para].url || "https://freemycloud.pw/auth/login"; //填写签到登陆链接
  var checkinemail = res[para].email || "a735236642@outlook.com"; //填写签到邮箱
  var checkinpwd = res[para].password || "kyxCoj-xipso1-favhot";
} catch (e) {
  log("获取JSON文件失败");
}
const size = 12; //字体大小
