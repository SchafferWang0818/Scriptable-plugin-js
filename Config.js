...
module.exports = {
  ...
  checkintitle: () => "FreeMyCloud", //填写签到标题
  checkinloginurl: () => "https://freemycloud.pw/auth/login", //填写签到登陆链接
  checkinemail: () => "a735236642@outlook.com", //填写签到邮箱
  checkinpwd: () => "kyxCoj-xipso1-favhot", //填写签到密码
  apps: () => [
    "1443988620|hk",
    "1312014438 cn",
    "499470113/vn",
